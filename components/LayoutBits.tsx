...
export function PageHeader({ h1, lede }: { h1: string; lede?: string }) {
  return (
    <header className="bg-brand-deep text-surface pt-8 pb-10 md:pt-14 md:pb-20">
      <Container>
        <h1 className="font-display font-semibold text-[clamp(2rem,5vw,3.75rem)] leading-[1.15] max-w-[22ch]">
          {h1}
        </h1>
        <MotionRise>
...
export function TextLink({
  ...
  const className = "text-link underline underline-offset-2 hover:text-brand-deep";
  if (external) {
    return (
